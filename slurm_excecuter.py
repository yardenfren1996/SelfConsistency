...
python paraphrasing.py --model {args.model} --dataset {args.dataset} --from_index {start_idx} --to_index {end_idx} --results_filename "distributed/{args.results_filename}_{batch_num}" --no_generations {args.no_generations}
"""
# python self_consistency.py --model {args.model} --dataset {args.dataset} --from_index {start_idx} --to_index {end_idx} --results_filename "distributed/{args.results_filename}_{batch_num}" --no_generations {args.no_generations} --no_seeds {args.no_seeds}
#python paraphrasing.py --model {args.model} --dataset {args.dataset} --from_index {start_idx} --to_index {end_idx} --results_filename "distributed/{args.results_filename}_{batch_num}" --no_generations {args.no_generations}
